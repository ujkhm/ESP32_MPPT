...
本專案採用 **[MIT License](LICENSE)** 授權。<br>
-  您可以自由地使用、複製、修改、合併、出版發行、散佈、再授權及販售本軟體與相關硬體設計檔。<br>
- 本專案為實驗性質，開發者不對因使用本專案內容而導致的任何直接或間接損失負責。<br>
- 在使用或修改本專案內容時，請在您的專案中包含原作者的版權宣告與授權條款。<br>
